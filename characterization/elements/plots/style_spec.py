...
METRIC_STYLES: dict[str, dict[str, str]] = {
    ...
    "power_at_adc_min": {"color": "#2A9D8F", "marker": DEFAULT_MARKER, "linestyle": "-"},
    "power_at_adc_max": {"color": "#E76F51", "marker": DEFAULT_MARKER, "linestyle": "-"},
    "power_range_fill": {"color": "#4C78A8", "marker": DEFAULT_MARKER, "linestyle": DEFAULT_LINESTYLE},
    "power_range_rect_edge": {"color": "#264653", "marker": DEFAULT_MARKER, "linestyle": DEFAULT_LINESTYLE},
    "sim_power_range_fill": {"color": "#E9C46A", "marker": DEFAULT_MARKER, "linestyle": DEFAULT_LINESTYLE},
    "sim_power_range_edge": {"color": "#8A5A44", "marker": DEFAULT_MARKER, "linestyle": DEFAULT_LINESTYLE},
