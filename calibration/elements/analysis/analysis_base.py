...
class BaseAnal(ABC):
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        self._internal_sanity:List[SanityCheckResult] = []
    ...
    def add_sanity_check_error(self, check_name: str, info: str = "", severity:str='info'):
        """Add a sanity check result to the internal list.
        This is only for internal sanity checks generated by the code itself
        The checks configured externally to verify other conditions are handled on SanityChecks class

        Args:
            check (bool): Result of the sanity check.
        """
        self._internal_sanity.append(SanityCheckResult(check_name=check_name, 
                                                       severity=severity,
                                                       passed=False,
                                                       exec_error=False,
                                                       internal=True,
